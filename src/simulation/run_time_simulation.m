...
if isempty(sampleCount)
    % Let the solver return its adaptive internal mesh. This is important
    % for convergence-rate work: a coarse uniform output grid quantizes the
    % sharp prey maxima of the relaxation oscillation.
    tspan = [0 totalTime];
else
